...
\newcommand{\hyplink}[2]{\href{#1}{\textcolor{blue}{#2}}}
...
\input{./tex/071-performances.tex}
...
\begin{thebibliography}{99}\addcontentsline{toc}{section}{参考文献}
	...
	\bibitem{cd} 「ブラームス・コンプリート・エディション 6 - 歌曲集（バンゼ／シュミット／ドイチュ）」 (CPO) のブックレット (\hyplink{http://ml.naxos.jp/album/999446-2}{NML})
	\bibitem{liedernet} The LiederNet Archive (\hyplink{http://www.lieder.net/lieder/get_text.html?TextId=7524}{第1曲},
		\hyplink{http://www.lieder.net/lieder/get_text.html?TextId=15078}{第2曲}, \hyplink{http://www.lieder.net/lieder/get_text.html?TextId=3573}{第3曲},
		\hyplink{http://www.lieder.net/lieder/get_text.html?TextId=9974}{第4曲}, \hyplink{http://www.lieder.net/lieder/get_text.html?TextId=8307}{第5曲})
\end{thebibliography}
